...
Если Flash Note Text помогает экономить время при записи, форматировании и публикации текста, вы можете поддержать автора с помощью QR-кодов ниже. Выберите способ оплаты:

<p align="center">
  <img src="../public/donate/wechat-pay.png" width="220" alt="QR-код для пожертвования через WeChat Pay">
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="../public/donate/alipay.png" width="220" alt="QR-код для пожертвования через Alipay">
</p>
